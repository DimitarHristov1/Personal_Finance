...
{
    public partial class Costs_Form : Form
    {
        ...
        private void DisplayData()
        {
            ...
            listView_incomes.Columns.Add("Идент. номер на разход");
            listView_incomes.Columns.Add("Име на разход");
            listView_incomes.AutoResizeColumns(ColumnHeaderAutoResizeStyle.HeaderSize);
            con.Open();
            string queryString = "select * from INCOME_EXPNECE where INCEXP_TYPE = 'C'";
